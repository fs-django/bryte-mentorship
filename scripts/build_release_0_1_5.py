...
def main() -> None:
    ...
    manifest["description"] = "Plan mentorship studies, pull released Units, restore saved student work from GitHub, memorize passage summaries, and keep meeting notes."
