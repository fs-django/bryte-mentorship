...
def main() -> None:
    ...
    manifest["description"] = "Plan mentorship studies, restore private GitHub coursework and Markdown notes, memorize passage summaries, and keep meeting notes."
    write_json(OUT_DIR / "manifest.json", manifest)
    write_json(ROOT / "manifest.json", manifest)

    versions = json.loads((BASE_DIR / "versions.json").read_text(encoding="utf-8"))
    for version in ["0.1.5", "0.1.6", VERSION]:
